...
# load four courners
points = np.loadtxt("/home/luyijie/f1tenth_ws/src/lab-5-slam-and-pure-pursuit-team-2-1/pure_pursuit/waypoints/wp_corner.csv", delimiter=",", dtype=float)
x = points[:, 0]
y = points[:, 1]
...
# save as csv
np.savetxt("/home/luyijie/f1tenth_ws/src/lab-5-slam-and-pure-pursuit-team-2-1/pure_pursuit/waypoints/wp_interpolated.csv", 
           data, 
           delimiter=",")